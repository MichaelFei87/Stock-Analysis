...
Also extracts Phase 5 insight falsification conditions (LEGACY — Phase 5
removed in v5.1.4; retained for backward compatibility with older reports).
...
@dataclass
class InsightPoint:
    """A Phase 5 insight with its falsification condition.  # LEGACY — Phase 5 removed in v5.1.4"""
    index: int  # "#1", "#2" ...
    title: str
    hypothesis: str
    level: str  # A / B / C
...
# ---------- Phase 5 insight extractor (LEGACY — Phase 5 removed in v5.1.4) ----------
