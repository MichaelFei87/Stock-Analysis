...
3. 可选: `phase5-variant-perception.md`（旧版报告可能存在，若无则跳过洞察证伪）
...
2. 若存在旧版 `phase5-variant-perception.md`，解析每条洞察的"证伪条件"和"置信度"/"时间窗"（v5.1.4 起新报告无此文件）
...
## §2 洞察证伪检查（LEGACY — 仅旧版报告含 Phase 5 洞察时有内容）
